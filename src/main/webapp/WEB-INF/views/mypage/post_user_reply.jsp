			...
			<div id="wrapper" class="container-fluid">
				...
				<div id="content">
					<ul class="list-inline">
						<li class="list-inline-item"><a href="${pageContext.servletContext.contextPath}/mypage/post_user">작성 글</a></li>
						<li class="list-inline-item"><a href="${pageContext.servletContext.contextPath}/mypage/post_user/reply">작성 댓글</a></li>
					</ul>
					<hr/>
					<table class="table">
						<thead>
