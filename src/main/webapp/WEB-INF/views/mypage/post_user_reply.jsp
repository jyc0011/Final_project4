...
<div id="wrapper" class="container-fluid">
    ...
    <div id="content">
        <ul class="list-inline">
            <li class="list-inline-item"><a href="${pageContext.servletContext.contextPath}/mypage/post_user">POST</a>
            </li>
            <li class="list-inline-item"><a href="${pageContext.servletContext.contextPath}/mypage/post_user/reply" id="now">COMMENT</a></li>
        </ul>
