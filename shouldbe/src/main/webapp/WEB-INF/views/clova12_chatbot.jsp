...
<title>챗봇 Test</title>
	...
	<style>
		.chatbotMain { width:600px; margin:0 auto; }
		#content { overflow: scroll; height:400px; border:1px solid #ddd; }
		.queRight, .queLeft {padding: 10px; margin: 10px; border-radius:5px; clear:both; }
		.queRight {  text-align:right; background: pink; float:right; }
		.queLeft { text-align:left; background: #A5FFE4	; float:left; }
	</style>
	<script>
		$(function() {
