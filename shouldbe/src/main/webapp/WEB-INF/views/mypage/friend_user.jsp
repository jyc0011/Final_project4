			...
			<div id="wrapper" class="container-fluid">
				<div id="sidebar">
					...
					<ul class="sidebar-menu">
						...
						<li><a href="#">작성한글</a></li>
						<li><a href="#" class="active">친구관리</a></li>
						<li><a href="#">탈퇴하기</a></li>
						<li><a href="#">저장소</a></li>
					</ul>
				</div>
				<div id="content" class="col-10">
					<ul class="list-inline">
						<li class="list-inline-item"><a href="#">친구 목록</a></li>
						<li class="list-inline-item"><a href="#">차단 목록</a></li>
					</ul>
					<hr />
					<div class="friend-card"><!--ajax 처리-->
						<div class="friend-avatar">
							<img src="avatar_placeholder.png" alt="Friend's Avatar" class="rounded-circle"
